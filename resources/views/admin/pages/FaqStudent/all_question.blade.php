...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-bold mb-0 text-primary">Student FAQs</h4>
        <a href="{{ route('admin.faq-students.create') }}" class="btn btn-primary shadow-sm">
                    ...
                    @forelse($faqs as $faq)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.faq-students.edit', $faq) }}" class="text-warning me-2" title="Edit">
                                    <i class="fas fa-edit fa-lg"></i>
                                </a>
                                <form action="{{ route('admin.faq-students.destroy', $faq) }}" method="POST" class="d-inline">
                                    @csrf @method('DELETE')
